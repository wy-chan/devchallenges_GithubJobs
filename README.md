...
<i style="color:gray">Due to depreciation of GitHub Jobs site, I used another API for this page. Some features listed below are not available in this API.</i>
...
- [x] User story: I can search for a full-time job only <i style="color:gray">(I changed this to "levels" options due to features of the API.)</i>
- [x] User story: I can see a list of jobs with their logo, company name, location, and posted time. <i style="color:gray">(Company logo is not provided in this API.)</i>
...
#### API:
<i style="color:gray">(The GitHub Jobs API -https://jobs.github.com/api is no longer available)</i>
